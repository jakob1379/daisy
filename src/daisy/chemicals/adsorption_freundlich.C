...
double 
AdsorptionFreundlich::C_to_M (const Soil& soil, double Theta, double,
...
double 
AdsorptionFreundlich::M_to_C (const Soil& soil, double Theta, double T,
			      int i, double M, double sf) const
{
  ...
  double min_C = 0.0;
  double min_M = C_to_M (soil, Theta, T, i, min_C, sf);
  double max_C = 1.0;
  double max_M = C_to_M (soil, Theta, T, i, max_C, sf);
  ...
  while (max_M < M)
    {
      ...
      max_M = C_to_M (soil, Theta, T, i, max_C, sf);
    }
  ...
  while (!approximate (min_M, max_M))
    {
      ...
      const double new_M = C_to_M (soil, Theta, T, i, new_C, sf);
      if (new_M < M)
	{
