// litter_interface.h -- Litter layer below vegetation.
// 
...
#ifndef LITTER_INTERFACE_H
#define LITTER_INTERFACE_H
...
struct LitterInterface
{
  ...
  virtual double water_protected () const = 0;    // Water not evapable [mm]
  virtual double albedo () const = 0;  // Light reflection factor []
  virtual double potential_exfiltration () const = 0; // Water exchange with soil [mm/h]
